...
const ListChangeOneLetter = (props)=> {
    ...
    const handleChangePage = (
        ...
        props.history.push('/change-one-letter/open/pages/'+size+'/'+newPage)
      };

      const handleChangeRowsPerPage = (
        event
      ) => {
        props.history.push('/change-one-letter/open/pages/'+sizeByLabel[parseInt(event.target.value, 10)]+'/0')
      };
        ...
        return (
            <TableContainer component={Paper}>
              <Table sx={{ minWidth: 650 }} aria-label="simple table">
                <TableHead>
                  <TableRow>
                    <TableCell align="center">Initial Word</TableCell>
                  ...
                  .map((row) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        ...
                        <Link to={`/change-one-letter/open/run/${row.id}`} className={"btn btn-primary"}>Open</Link>
