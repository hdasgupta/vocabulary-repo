...
const ListChangeOneLetter = (props)=> {
    ...
    const handleChangePage = (
        ...
        props.history.push('/guess-the-word/open/pages/'+size+'/'+newPage)
      };

      const handleChangeRowsPerPage = (
        event
      ) => {
        props.history.push('/guess-the-word/open/pages/'+sizeByLabel[parseInt(event.target.value, 10)]+'/0')
      };
                  ...
                  .map((row) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        ...
                        <Link to={`/guess-the-word/open/run/${row.id}`} className={"btn btn-primary"}>Open</Link>
...
function TablePaginationActions(props) {
  ...
  const firstUrl = '/guess-the-word/open/pages/'+sizeByLabel[rowsPerPage]+'/0'
  const prevUrl = '/guess-the-word/open/pages/'+sizeByLabel[rowsPerPage]+'/'+(page-1)
  const nextUrl = '/guess-the-word/open/pages/'+sizeByLabel[rowsPerPage]+'/'+nextPage
  const lastUrl = '/guess-the-word/open/pages/'+sizeByLabel[rowsPerPage]+'/'+lastPage
